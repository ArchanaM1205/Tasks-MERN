  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen">
        <div className="w-fit">
          <h1 className="mb-[50px]">Welcome to Login Page</h1>
          ...
          <Link to='/Dashboard'><button className="btn bg-white text-black border-[#e5e5e5] mt-5 btn btn-primary w-full">
          ...
          <div>
            <h1>Donot have an Account?<Link to="/register"><button className="link link-hover">Register</button></Link></h1>
          </div>
        </div>
      </div>
    </>
